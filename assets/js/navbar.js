$(document).ready(function()
{
    $('#navbar_replacement').replaceWith('\
        ...
        <div class="container">\
            ...
            <a class="navbar-brand" href="index.html"><img class="img-responsive" style="width:280px;max-width:100%,max-height:100px" src="assets/img/NoCaSS2020_transparent.png" alt="NoCaSS 2020"></a>\
            </div>\
